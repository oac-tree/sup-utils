...
The ``sup/xml`` package provides tools for working with XML data, including parsing, serialization, and validation. It is built on top of the `libxml2 <https://github.com/GNOME/libxml2>`_ library.
